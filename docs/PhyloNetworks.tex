...
WARNING: There is a known bug for Mac users where the \texttt{Pkg.update} function does not update to the latest version. We recommend Mac users to do the following through the terminal:\\
\texttt{
...
\item \textbf{topologyMaxQPseudolik:} For a given network, you can
  ...
  before for the \texttt{snaq} function.
  \\
  Usage:
  \begin{lstlisting}
