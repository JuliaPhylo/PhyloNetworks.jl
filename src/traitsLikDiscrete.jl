...
# See latex pseudocode doc for full explanation of the network, rate, 
# branch length, gamma search and optimization algorithm
####
...
# """
#     prepdata(net::HybridNetwork, dnadata::DataFrame, modsymbol::Symbol)
...
#     kinds of data (snp, amino acids). Start with dna
#     should call readfastatodna(), startingrate(), startingBL!()
#     Similar to fitdiscrete()
# """
function prepdata(net::HybridNetwork, fastafile::String, modsymbol::Symbol)
...
# """
#     writessmtofile(SSMobject::SSM)

# write SSM data to a file so that users only need to call prep data once
# TODO
# """

# """
#     wrapper(net::HybridNetwork, dnadata::DataFrame, siteweights::VectorFloat, 
#     modSymbol::Symbol, optim=:all::Symbol; kwargs)

# Users call this function with their data to start the full process.
# have an option for a user-defined model with their own rates. 
#     calls these functions:
#     addclades!(obj::SSM, clade)
#     fit!(obj::SSM, :all::Symbol; kwargs)
#     startingBL!(net::HybridNetwork, trait::Vector{Vector{Union{Missing,Int}}},
#     siteweight::Union{Missings.Missing, Vector{Float64}})
...
Take a symbol and data to create a statistical substitution model.
default site weights
explain why is net necessary
relative version
"""
...
# ## Functions to Update SSM Objects Efficiently ##

# # function updatessm!(candidateobj::SSM, orig::SSM, :BL::Symbol, uv::Edge) update local edges around uv so that they match orig SSM
# # end function
# # function updatessm!(candidateobj::SSM, :substitutionmodel, originalobj::SSM)
# # update Q of candidate object using origObj.model.Q
# # end function
# # function updatessm!(candidateobj::SSM, :alpha, originalobj::SSM)
# # update alpha of candidate object using origObj.ratemodel.alpha
# # end function
