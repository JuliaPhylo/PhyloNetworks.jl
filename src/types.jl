...
A `QuartetNetwork` object is an internal type used to calculate the expected CFs of quartets on a given network. Attributes of the `QuartetNetwork` objects need not be updated at a given time (see below).
...
1. Deep copy of full network is done to create `q.qnet` for `Quartet q`. This `QuartetNetwork` object has only 4 leaves now, but does not have merged edges (the identifiable ones) so that we can correspond to the edges in net. This `QuartetNetwork` does not have other attributes updated.
...
```jldoctest
julia> net0 = readTopology("(s17:13.765659574468085,(((s3:10.980829787234043,(s4:8.98882978723404,s5:8.98882978723404)I1:1.992)I2:0.471,(((s6:2.307829787234041,s7:2.307829787234041)I3:4.026,(s8:4.974829787234041,#H24:0.0::0.279)I4:1.3589999999999995)I5:3.6390000000000002,((s9:8.28982978723404,((s10:2.3768297872340414,s11:2.3768297872340414)I6:3.018,(s12:2.6768297872340416,s13:2.6768297872340416)I7:2.718)I8:2.895)I9:0.21000000000000002,((s14:2.8328297872340418,(s15:1.0568297872340429,s16:1.0568297872340429)I10:1.7759999999999998)I11:2.142)#H24:3.5250000000000004::0.721)I12:1.4729999999999999)I13:1.479)I14:1.257,(((s18:5.46082978723404,s19:5.46082978723404)I15:0.5880000000000001,(s20:4.725829787234041,(s21:2.4008297872340414,s22:2.4008297872340414)I16:2.325)I17:1.323)I18:2.682,(s23:8.56582978723404,(s1:4.641829787234041,s2:4.641829787234041)I19:3.9240000000000004)I20:0.165)I21:3.978)I22:1.0568297872340426);");
...
(s4:8.989,s5:8.989,(s3:10.0,((((s6:2.308,s7:2.308)I3:4.026,(s8:4.975,#H24:0.0::0.279)I4:1.359)I5:3.639,((s9:8.29,((s10:2.377,s11:2.377)I6:3.018,(s12:2.677,s13:2.677)I7:2.718)I8:2.895)I9:0.21,((s14:2.833,(s15:1.057,s16:1.057)I10:1.776)I11:2.142)#H24:3.525::0.721)I12:1.473)I13:1.479,((((s18:5.461,s19:5.461)I15:0.588,(s20:4.726,(s21:2.401,s22:2.401)I16:2.325)I17:1.323)I18:2.682,(s23:8.566,(s1:4.642,s2:4.642)I19:3.924)I20:0.165)I21:3.978,s17:10.0)I22:1.257)I14:0.471)I2:1.992)I1;

julia> q1 = Quartet(1,["s1", "s16", "s18", "s23"],[0.29605,0.305921,0.398026])
number: 1
taxon names: ["s1", "s16", "s18", "s23"]
observed CF: [0.29605, 0.305921, 0.398026]
