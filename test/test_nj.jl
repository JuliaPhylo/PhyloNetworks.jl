@testset "neighbour joining tree" begin
    ...
    tree = (@test_logs (:info, r"negative length") nj(df))
    @test writeTopology(tree) == "(((s1:2.0,s2:3.0):3.0,s3:4.0):2.0,s5:-2.0,s4:2.0);"
    ...
    @test writeTopology(tree) == "(((1:2.0,2:3.0):3.0,3:4.0):2.0,5:0.0,4:2.0);"
end
