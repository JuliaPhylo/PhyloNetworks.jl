...
@test eltype(childrenof(net.node[6])) == PhyloNetworks.Node
@test eltype(parentsof(net.node[6]))  == PhyloNetworks.Node
@test eltype(childedgesof(net.node[6]))  == PhyloNetworks.Edge
@test eltype(parentedgesof(net.node[6])) == PhyloNetworks.Edge
